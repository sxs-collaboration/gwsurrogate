...
def test_model_regression(generate_regression_data=False):
  ...
  if generate_regression_data:
    ...
    try: # try importing data. If it doesn't exist, download it
      ...
      # w/ faulty CCE file (6/2023): https://www.dropbox.com/s/kqtyhgiqqio8hgb/model_regression_data.h5
      os.system('wget -O test/model_regression_data.h5 https://www.dropbox.com/scl/fi/qrbqr6yr6ugrbduxsxqpq/model_regression_data.h5?rlkey=e3t347bo3hebux7rghc2drkzk')
      fp_regression = h5py.File("test/model_regression_data.h5",'r') 
